...
<b>Хочется начать заниматься регулярно, но полноценные часовые тренировки постоянно откладываются на «когда будет время»?

Я собрала 5 коротких практик йоги по 20–25 минут, которые можно просто открыть утром и начать — без необходимости самой придумывать, что сегодня делать на коврике.

В каждой практике есть всё, что я считаю важным: — настройка и работа с дыханием — полноценная последовательность асан — понятные подсказки по технике — шавасана в конце

маленькая полноценная практика от начала до конца.

Подойдёт, если вы только начинаете заниматься йогой или хотите добавить короткие практики в свою обычную жизнь.

Внутри: 5 тренировок по 20–25 минут</b> 

<b>Доступ: навсегда Стоимость: 999 ₽/b>"""
