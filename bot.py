...
Хочется начать заниматься регулярно, но полноценные часовые тренировки постоянно откладываются на «когда будет время»?

Я собрала <b>5 коротких практик йоги по 20–25 минут</b>, которые можно просто открыть утром и начать — без необходимости самой придумывать, что сегодня делать на коврике.

В каждой практике есть всё, что я считаю важным:
— настройка и работа с дыханием
— полноценная последовательность асан
— понятные подсказки по технике
— шавасана в конце

<b>маленькая полноценная практика от начала до конца</b>.
